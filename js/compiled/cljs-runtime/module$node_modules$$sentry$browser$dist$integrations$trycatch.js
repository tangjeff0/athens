...
(global=global[target]&&global[target].prototype)&&global.hasOwnProperty&&global.hasOwnProperty("addEventListener")&&(utils_1.fill(global,"addEventListener",function(original){return function(eventName,fn,options){try{"function"===typeof fn.handleEvent&&(fn.handleEvent=helpers_1.wrap(fn.handleEvent.bind(fn),{mechanism:{data:{function:"handleEvent",handler:utils_1.getFunctionName(fn),target:target},handled:!0,type:"instrument"}}))}catch(err){}return original.call(this,eventName,helpers_1.wrap(fn,{mechanism:{data:{function:"addEventListener",
handler:utils_1.getFunctionName(fn),target:target},handled:!0,type:"instrument"}}),options)}}),utils_1.fill(global,"removeEventListener",function(original){return function(eventName,fn,options){try{original.call(this,eventName,fn.__sentry_wrapped__,options)}catch(e$129){}return original.call(this,eventName,fn,options)}}))};TryCatch.prototype._wrapXHR=function(originalSend){return function(){for(var args=[],_i=0;_i<arguments.length;_i++)args[_i]=arguments[_i];var xhr=this;["onload","onerror","onprogress",
"onreadystatechange"].forEach(function(prop){prop in xhr&&"function"===typeof xhr[prop]&&utils_1.fill(xhr,prop,function(original){var wrapOptions={mechanism:{data:{function:prop,handler:utils_1.getFunctionName(original)},handled:!0,type:"instrument"}};original.__sentry_original__&&(wrapOptions.mechanism.data.handler=utils_1.getFunctionName(original.__sentry_original__));return helpers_1.wrap(original,wrapOptions)})});return originalSend.apply(this,args)}};TryCatch.id="TryCatch";return TryCatch}();
exports.TryCatch=global$jscomp$0}
