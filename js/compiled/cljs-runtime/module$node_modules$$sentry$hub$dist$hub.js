...
function(){return this.getStackTop().scope};Hub.prototype.getStack=function(){return this._stack};Hub.prototype.getStackTop=function(){return this._stack[this._stack.length-1]};Hub.prototype.captureException=function(exception,hint){var eventId=this._lastEventId=utils_1.uuid4(),finalHint=hint;if(!hint){try{throw Error("Sentry syntheticException");}catch(exception$122){hint=exception$122}finalHint={originalException:exception,syntheticException:hint}}this._invokeClient("captureException",exception,
tslib_1.__assign(tslib_1.__assign({},finalHint),{event_id:eventId}));return eventId};Hub.prototype.captureMessage=function(message,level,hint){var eventId=this._lastEventId=utils_1.uuid4(),finalHint=hint;if(!hint){try{throw Error(message);}catch(exception){hint=exception}finalHint={originalException:message,syntheticException:hint}}this._invokeClient("captureMessage",message,level,tslib_1.__assign(tslib_1.__assign({},finalHint),{event_id:eventId}));return eventId};Hub.prototype.captureEvent=function(event,
hint){var eventId=this._lastEventId=utils_1.uuid4();this._invokeClient("captureEvent",event,tslib_1.__assign(tslib_1.__assign({},hint),{event_id:eventId}));return eventId};Hub.prototype.lastEventId=function(){return this._lastEventId};Hub.prototype.addBreadcrumb=function(breadcrumb,hint){var _a=this.getStackTop(),scope=_a.scope;_a=_a.client;if(scope&&_a){_a=_a.getOptions&&_a.getOptions()||{};var _c=_a.beforeBreadcrumb,beforeBreadcrumb=void 0===_c?null:_c;_a=_a.maxBreadcrumbs;_a=void 0===_a?100:_a;
if(!(0>=_a)){_c=utils_1.dateTimestampInSeconds();var mergedBreadcrumb=tslib_1.__assign({timestamp:_c},breadcrumb);breadcrumb=beforeBreadcrumb?utils_1.consoleSandbox(function(){return beforeBreadcrumb(mergedBreadcrumb,hint)}):mergedBreadcrumb;null!==breadcrumb&&scope.addBreadcrumb(breadcrumb,Math.min(_a,100))}}};Hub.prototype.setUser=function(user){var scope=this.getScope();scope&&scope.setUser(user)};Hub.prototype.setTags=function(tags){var scope=this.getScope();scope&&scope.setTags(tags)};Hub.prototype.setExtras=
