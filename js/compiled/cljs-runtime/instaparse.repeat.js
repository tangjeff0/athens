...
var vec__48099 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48099,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48099,(1),null);
...
var vec__48102 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48102,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48102,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__48105 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48105,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48105,(1),null);
...
var G__48166 = cljs.core.next(parses__$1);
parses__$1 = G__48166;
continue;
}
...
var G__48113 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__48114 = G__48113;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48114,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48114,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48114,(2),null);
var selection = vec__48114;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__48113__$1 = G__48113;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__48120 = G__48113__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48120,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48120,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48120,(2),null);
var selection__$1 = vec__48120;
...
var G__48168 = cljs.core.long$(end__$1);
var G__48169 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__48170 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__48168;
parses__$1 = G__48169;
G__48113__$1 = G__48170;
continue;
...
var G__48128 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__48129 = G__48128;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48129,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48129,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48129,(2),null);
var selection = vec__48129;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__48128__$1 = G__48128;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__48135 = G__48128__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48135,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48135,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48135,(2),null);
var selection__$1 = vec__48135;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__48172 = cljs.core.long$(end__$1);
var G__48173 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__48174 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__48172;
parses__$1 = G__48173;
G__48128__$1 = G__48174;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__48143 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__48144 = G__48143;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48144,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48144,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48144,(2),null);
var selection = vec__48144;
var index__$2 = index__$1;
var parses__$1 = parses;
...
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__48150 = G__48143__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48150,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48150,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48150,(2),null);
var selection__$1 = vec__48150;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__48176 = cljs.core.long$(end__$1);
var G__48177 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__48178 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__48176;
parses__$1 = G__48177;
G__48143__$1 = G__48178;
continue;
...
if(cljs.core.truth_((function (){var fexpr__48155 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__48155.cljs$core$IFn$_invoke$arity$1 ? fexpr__48155.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__48155.call(null,output_format));
})())){
} else {
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4115__auto__ = (function (){var G__48164 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__48163 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__48163.cljs$core$IFn$_invoke$arity$1 ? fexpr__48163.cljs$core$IFn$_invoke$arity$1(G__48164) : fexpr__48163.call(null,G__48164));
})();
