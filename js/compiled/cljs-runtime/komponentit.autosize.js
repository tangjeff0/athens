...
komponentit.autosize.apply_box_sizing = (function komponentit$autosize$apply_box_sizing(value,p__61831){
...
var box_sizing = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61832__$1,new cljs.core.Keyword(null,"box-sizing","box-sizing",-1956090239));
var border_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61832__$1,new cljs.core.Keyword(null,"border-size","border-size",991975640));
var padding_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61832__$1,new cljs.core.Keyword(null,"padding-size","padding-size",-733651675));
var G__61834 = box_sizing;
switch (G__61834) {
case "border-box":
...
var G__61835 = document.createElement("div");
document.body.appendChild(G__61835);

return G__61835;
}),null));
}
komponentit.autosize.node_width = (function komponentit$autosize$node_width(value,placeholder,placeholder_is_min_width_QMARK_,p__61836){
...
var styles = map__61837__$1;
var sizer_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61837__$1,new cljs.core.Keyword(null,"sizer-style","sizer-style",-1176226328));
 ...
 */
komponentit.autosize.input = (function komponentit$autosize$input(p__61839){
...
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var placeholder_is_min_width_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"placeholder-is-min-width?","placeholder-is-min-width?",-1743052093));
...
}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (this$,p__61842){
var vec__61843 = p__61842;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61843,(0),null);
var prev_props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61843,(1),null);
...
}),new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),(function (p__61846){
...
var props = map__61847__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61847__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61847__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61847__$1,new cljs.core.Keyword(null,"value","value",305978217));
var placeholder__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61847__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
...
var G__61849 = document.createElement("div");
document.body.appendChild(G__61849);

return G__61849;
}),null));
}
komponentit.autosize.node_height = (function komponentit$autosize$node_height(value,min_rows,max_rows,p__61850){
...
var styles = map__61851__$1;
var box_sizing = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61851__$1,new cljs.core.Keyword(null,"box-sizing","box-sizing",-1956090239));
var border_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61851__$1,new cljs.core.Keyword(null,"border-size","border-size",991975640));
var padding_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61851__$1,new cljs.core.Keyword(null,"padding-size","padding-size",-733651675));
var sizer_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61851__$1,new cljs.core.Keyword(null,"sizer-style","sizer-style",-1176226328));
 ...
 *   component, for easier styling.
 */
komponentit.autosize.textarea = (function komponentit$autosize$textarea(p__61853){
...
var min_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61854__$1,new cljs.core.Keyword(null,"min-rows","min-rows",1428640765));
var max_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61854__$1,new cljs.core.Keyword(null,"max-rows","max-rows",-2131113613));
var state = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(null);
...
}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (this$,p__61856){
var vec__61857 = p__61856;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61857,(0),null);
var prev_props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61857,(1),null);
if(((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(reagent.core.props(this$)),new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(prev_props))) || (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(reagent.core.props(this$)),new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(prev_props))))){
return cljs.core.reset_BANG_(state,komponentit.autosize.textarea_node_styles(reagent.dom.dom_node(this$)));
} else {
return null;
}
}),new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),(function (p__61860){
...
var props = map__61861__$1;
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61861__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61861__$1,new cljs.core.Keyword(null,"value","value",305978217));
var min_rows__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61861__$1,new cljs.core.Keyword(null,"min-rows","min-rows",1428640765));
var max_rows__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61861__$1,new cljs.core.Keyword(null,"max-rows","max-rows",-2131113613));
