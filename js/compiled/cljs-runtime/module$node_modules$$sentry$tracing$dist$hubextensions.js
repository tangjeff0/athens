...
function getDefaultSamplingContext(transactionContext){transactionContext={transactionContext:transactionContext,parentSampled:transactionContext.parentSampled};if(utils_1.isNodeEnv()){var domain=hub_1.getActiveDomain();if(domain){var requestType_1=utils_1.dynamicRequire(module,"http").IncomingMessage;if(domain=domain.members.find(function(member){return utils_1.isInstanceOf(member,requestType_1)}))transactionContext.request=utils_1.extractNodeRequestData(domain)}}else domain=utils_1.getGlobalObject(),
"location"in domain&&(transactionContext.location=tslib_1.__assign({},domain.location));return transactionContext}function _startTransaction(transactionContext,customSamplingContext){var transaction=new transaction_1.Transaction(transactionContext,this);return sample(this,transaction,tslib_1.__assign(tslib_1.__assign({},getDefaultSamplingContext(transactionContext)),customSamplingContext))}function _addTracingExtensions(){var carrier=hub_1.getMainCarrier();carrier.__SENTRY__&&(carrier.__SENTRY__.extensions=
