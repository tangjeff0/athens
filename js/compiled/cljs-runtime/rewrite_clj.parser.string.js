...
if((c === "\n")){
var G__29652 = escape_QMARK_;
var G__29653 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__29652;
lines = G__29653;
continue;
} else {
buf.append(c);

var G__29654 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__29655 = lines;
escape_QMARK_ = G__29654;
lines = G__29655;
continue;
...
var G__29649 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__29649) : rewrite_clj.node.string_node.call(null,G__29649));
});
...
var G__29650 = cljs.core.re_pattern(regex);
var G__29651 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__29650,G__29651) : rewrite_clj.node.token_node.call(null,G__29650,G__29651));
});
