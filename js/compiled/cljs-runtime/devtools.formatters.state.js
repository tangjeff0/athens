...
var len__4736__auto___23499 = arguments.length;
var i__4737__auto___23500 = (0);
while(true){
if((i__4737__auto___23500 < len__4736__auto___23499)){
args__4742__auto__.push((arguments[i__4737__auto___23500]));

var G__23501 = (i__4737__auto___23500 + (1));
i__4737__auto___23500 = G__23501;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq23496){
...
return cljs.core.some((function (p1__23498_SHARP_){
return (p1__23498_SHARP_ === object);
}),history);
});
