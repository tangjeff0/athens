...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20613__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20613__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20613__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var temp__5733__auto___20632 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20632)){
var seen_errors_20633 = temp__5733__auto___20632;
if(cljs.core.truth_(seen_errors_20633.has(self))){
} else {
seen_errors_20633.add(self);

var temp__5735__auto___20634 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20634)){
var sense_20635 = temp__5735__auto___20634;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20635)].join(''));
} else {
}
}
} else {
